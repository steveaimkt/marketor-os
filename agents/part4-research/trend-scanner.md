...
chains_to: [email-newsletter, content-planning]
gate: false
...
→ email-newsletter (주간 트렌드 DB) · content-planning (주제 후보) · 검색량 도구는 보관 중이라 검색량 칸은 비워 둡니다
...
방법론 정본 = `100-skills/01-research/skills/005-trend-scanning/SKILL.md` (marketing-100-skills 005)
