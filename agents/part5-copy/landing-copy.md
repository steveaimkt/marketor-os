...
data_sources:
  ...
  competitor_refs: competitor-monitor 결과 호출
...
3. `competitor-monitor` 호출 → 경쟁사 카피 패턴 (광고 소재 수집기는 보관 중 · 랜딩·SNS 공개 카피만 본다)
...
방법론 정본 = `100-skills/06-commerce/skills/051-detail-page-24/SKILL.md` (marketing-100-skills 051)
