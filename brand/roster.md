# 에이전트 팀 명단 (roster.md) · 이식 파일럿용

> **이 파일의 정체**: 75명 전체를 그대로 얹지 않고, 그 회사가 **실제로 하는 업무**(org-map.md §2)에 해당하는 에이전트만 켜는 팀 명단.
...
## 팀장 10 (업무 카테고리 존재 시 켬)
| 팀장 | 담당 스킬 | 켤까? | 근거(org-map §2 어느 업무) |
|---|---|---|---|
...
| SNS | threads-writer · sns-reaction-monitor | ⬜ |
...
- **[검증됨]**: 이 회사 실전 투입 확인 (예: acquiring-editor·voc-analyzer 계열)
...
## 재편 근거 (2026-08-02 · 대표 확정 구조)
- 정본 분해표: `brand/업무-스킬-분해표.md` (실업무→방법론→팀·기둥·맞춤 우선순위)
- 켜짐: 10부서 중 9 (광고성과실은 강의 실습용 접힘 · deptOff)
- 팀별 실업무 지시문: `brand/dashboard.json > deptWork` · 맞춤 스킬 매핑: `skillMap`
