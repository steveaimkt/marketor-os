...
description: |
  ...
  특이점: 본 스킬은 "처음 진입할 때 자동 발동" 되도록 설계. 학습용 상세 가이드는 [mcp-setup/youtube-data/SKILL.md](../../mcp-setup/youtube-data/SKILL.md) 참조.
---
...
다음 Bash 명령을 1회 실행. **사용자에게 되묻지 않고 바로 진행**.
...
예시: [`analysis/2026-05-26-channel-baseline/`) (첫 베이스라인)
...
- 본 스킬은 유튜브 분석 환경의 **자동 진입점**
- 상세 학습용 SKILL.md (소개·Before/After 포함): [mcp-setup/youtube-data/SKILL.md](../../mcp-setup/youtube-data/SKILL.md)
- Phase 2 OAuth 별도 가이드: analytics-api-oauth.md)
- 활용 에이전트: `trend-scanner` · `youtube-content-analysis`
