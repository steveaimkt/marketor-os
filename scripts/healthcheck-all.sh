...
if [[ -f "$PROJECT_DIR/mcp-servers/google-sheets/oauth_credentials.json" ]]; then
  if [[ -f "$PROJECT_DIR/mcp-servers/google-sheets/token.json" ]]; then
    if [[ -d "$PROJECT_DIR/mcp-servers/google-sheets/node_modules" ]]; then
